export default function REMFEntry() {
  return (
    ...
    <textarea
      ...
      className="w-2xl max-w-3xl bg-black border border-indigo-700 rounded-xl px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-600 resize-y" 
